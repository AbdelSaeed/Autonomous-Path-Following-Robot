...
public:
   ...
   *
   *  @param[in]    geometry_msgs::Point origin - point of origin in robot centric image coordinates [m]
   *  @param[in]    eometry_msgs::Point destination - point of origin in robot centric image coordinates [m]
   ...
   */
     ...
     * Code from http://playtechs.blogspot.com/2007/03/raytracing-on-grid.html
     *
     *  @param[in]    x0 - x point of origin in robot centric image coordinates [m]
     *  @param[in]    y0 - y point of origin in robot centric image coordinates [m]
     *  @param[in]    x1 - x point of origin in robot centric image coordinates [m]
     *  @param[in]    y1 - y point of origin in robot centric image coordinates [m]
     *  @return bool  The points can be connected with a line which only goes over free space
     */
...
private:
     ...
     *
     *  @param[in]    x - x value of cell to check in robot centric image coordinates [cells]
     *  @param[in]    y - y value of cell to check in robot centric image coordinates [cells]
