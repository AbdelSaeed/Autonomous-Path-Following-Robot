 ...
 * @brief Sample file, face_goal server used
 * @version 1.0
 * @date 07-11-2020
 *
 */
...
public:
   ...
   */
  bool faceGoal(a4_setup::RequestGoal::Request& req, a4_setup::RequestGoal::Response& res);
...
private:
  ...
  PoseDataBuffer goalPoseBuffer_;   //! We store the goal pose (as it is provided in service and we want to reuse it
                                    //! later)
